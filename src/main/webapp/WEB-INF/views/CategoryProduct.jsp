		  ...
		  <c:if test="${not empty listOfList}">
		  	<c:forEach var="productList" items="${listOfList}">
		  	  <div class="dropdown" style="margin-bottom: 80px">
			      ...
			      <div class="dropdown-menu">
			        <a href="<%=request.getContextPath()%>/home/category/arrange?key=down&category=${productList.nameCate}"><i class="fa-solid fa-arrow-up-wide-short"></i></a>
			        <a href="<%=request.getContextPath()%>/home/category/arrange?key=up&category=${productList.nameCate}"><i class="fa-solid fa-arrow-down-wide-short"></i></a>
			      </div>
			    </div>
